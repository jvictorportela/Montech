...
public class RegistrarUsuarioUseCase : IRegistrarUsuarioUseCase
{
    ...
    public RegistrarUsuarioUseCase(IUsuarioWriteOnlyRepository writeOnlyRepository, IUsuarioReadOnlyRepository readOnlyRepository, IMapper mapper, IUnitOfWork unitOfWork, CriptografiaSenha senhaEncrypter)
    {
