...
public class UsuarioRepository : IUsuarioReadOnlyRepository, IUsuarioWriteOnlyRepository
{
    ...
    public async Task AdicionarUsuario(Domain.Entities.Usuario usuario)
    {
    ...
    public async Task<Domain.Entities.Usuario?> BuscarUsuario(long id)
    {
        return await _context.Usuarios.FindAsync(id);
    }

    public async Task<List<Domain.Entities.Usuario>> BuscarUsuarioAtivos()
    {
